...
namespace SCPE
{
    ...
    public class RenderScreenSpaceSkybox : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (isSceneView)
            {
                currentCam.AddCommandBuffer(UnityEngine.Rendering.CameraEvent.AfterSkybox, cmd);
            }
        ...
        private void CreateSkyboxCamera()
        {
            ...
            skyboxCam.AddCommandBuffer(UnityEngine.Rendering.CameraEvent.AfterSkybox, cmd);
        }
        ...
        public void Destroy()
        {
            if (isSceneView)
            {
                currentCam.RemoveCommandBuffer(UnityEngine.Rendering.CameraEvent.AfterSkybox, cmd);
            }
            else
            {
                if (skyboxCam)
                {
                    skyboxCam.RemoveCommandBuffer(UnityEngine.Rendering.CameraEvent.AfterSkybox, cmd);
