        ...
        void DrawInstallation()
        {
            ...
            using (new EditorGUILayout.VerticalScope())
            {
                ...
                */
                //Color space
                {
                    string colorText = (PlayerSettings.colorSpace == ColorSpace.Linear) ? "Linear" : "Linear is recommended";
                    SCPE_GUI.Status folderStatus = (PlayerSettings.colorSpace == ColorSpace.Linear) ? SCPE_GUI.Status.Ok : SCPE_GUI.Status.Warning;
